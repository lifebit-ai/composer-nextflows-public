...
workflow lifebitai_prs_multi_plink{
        ...
        main:
            ...
            if (params.ldpred1) {
                transform_gwas_vcf_ldpred1(ch_gwas_vcf)
            }

            if (params.prsice) {
                transform_gwas_vcf_prsice(ch_gwas_vcf)
            }
            ...
            if (params.prsice) {
                polygen_risk_calcs( transform_gwas_vcf_prsice.out.transformed_base,
            ...
            if ( params.ldpred1 ) {
                ldpred_coord(transform_gwas_vcf_ldpred1.out.transformed_base_ldpred,
...
workflow{
    ...
    lifebitai_prs_multi_plink(ch_gwas_vcf,
                                ch_target_pheno)
