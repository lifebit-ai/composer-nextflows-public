...
process create_report {
  ...
  cp -r ${report_dir}/* .
  cp ${study_id}/* .
  mv harmonisation-ebi-1-DTable.R DTable.R
  mv harmonisation-ebi-1-style.css style.css
...
workflow lifebitai_harmonisation_ebi{
    take:
        ch_input
    ...
    main:
        ...
        ch_harmonised_sumstats = munge_ebi.out.harmonised_sumstats
